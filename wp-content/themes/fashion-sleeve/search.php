			...
			<div class="row">
				<div class="col">
					...
					<header class="page-header">
						<?php printf( '<h1 class="page-title"><span class="page-title-label">%1$s</span> <span class="page-title-value">%2$s</span></h1>', esc_html__( 'Search Results for:', 'fashion-sleeve' ), get_search_query() ); ?>
					</header><!-- .page-header -->
